...
@section('Site-setup')
  ...
  <link rel="stylesheet" type="text/css" href="{{ URL::asset('css/me-cuisto/bootstrap.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ URL::asset('css/me-cuisto/style.css') }}">

  <!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
  <script src="{{ URL::asset('js/me-cuisto/jquery.min.js') }}"></script>

  <!-- start-smoth-scrolling -->
  <script type="text/javascript" src="{{ URL::asset('js/me-cuisto/move-top.js') }}"></script>
  <script type="text/javascript" src="{{ URL::asset('js/me-cuisto/easing.js') }}"></script>
   ...
   <div class="container">
      ...
      <div class="top-header">
         ...
         <div class="top-nav">
            <div class="navigation">
               ...
               <div class="navigation-right">
                  <span class="menu"><img src="{{ URL::asset('img/me-cuisto/menu.png') }}" alt=" " /></span>
        ...
        <div class="col-md-5 header-left">
          <img src="{{ URL::asset('img/me-cuisto/img1.jpg') }}" alt="">
        </div>
        <div class="clearfix"> </div>
      ...
      <div id="about" class="about">
        ...
        <div class="clearfix"> </div>
              <link href="{{URL::asset('css/me-cuisto/owl.carousel.css')}}" rel="stylesheet">
                  <script src="{{URL::asset('js/me-cuisto/owl.carousel.js')}}"></script>
      <script>
...
<div class="portfolio" id="port">
      ...
      <div class="portfolio-grids">
        <script src="{{URL::asset('js/me-cuisto/easyResponsiveTabs.js')}}" type="text/javascript"></script>
        <script type="text/javascript">
                  $(document).ready(function () {
            ...
            <div class="resp-tabs-container">
              <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
                <div class="col-md-3 team-gd ">
                    ...
                    <a href="#portfolioModal1" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="{{ URL::asset('img/me-cuisto/pic4.jpg') }}" alt="">
                ...
                <div class="col-md-3 team-gd ">
                    ...
                    <a href="#portfolioModal3" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="{{ URL::asset('img/me-cuisto/pic5.jpg') }}" alt="">
                ...
                <div class="col-md-3 team-gd ">
                    ...
                    <a href="#portfolioModal2" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="{{ URL::asset('img/me-cuisto/pic9.jpg') }}" alt="">
                ...
                <div class="col-md-3 team-gd ">
                    ...
                    <a href="#portfolioModal4" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="{{ URL::asset('img/me-cuisto/pic6.jpg') }}" alt="">
                ...
                <div class="col-md-3 team-gd yes_marg ">
                    ...
                    <a href="#portfolioModal5" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="{{ URL::asset('img/me-cuisto/pic10.jpg') }}" alt="">
                ...
                <div class="col-md-3 team-gd yes_marg ">
                    ...
                    <a href="#portfolioModal6" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="{{ URL::asset('img/me-cuisto/pic11.jpg') }}" alt="">
                ...
                <div class="col-md-3 team-gd yes_marg ">
                    ...
                    <a href="#portfolioModal7" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="{{ URL::asset('img/me-cuisto/pic13.jpg') }}" alt="">
                ...
                <div class="col-md-3 team-gd yes_marg ">
                    ...
                    <a href="#portfolioModal8" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="{{ URL::asset('img/me-cuisto/pic14.jpg') }}" alt="">
          ...
          <div class="container">
            ...
            <span class="border one"></span>
             ...
             <div class="news-grid w3l-agile">
              ...
              <a href="#" data-toggle="modal" data-target="#myModal1"> <img src="{{ URL::asset('img/me-cuisto/b1.jpg') }}" alt=" " class="img-responsive"></a>
            ...
            <div class="col-md-6 news-img two">
               <a href="#" data-toggle="modal" data-target="#myModal1"> <img src="{{ URL::asset('img/me-cuisto/b2.jpg') }}" alt=" " class="img-responsive"></a>
            ...
            <div class="news-grid">
              <div class="col-md-6 news-img">
              <a href="#" data-toggle="modal" data-target="#myModal1"> <img src="{{ URL::asset('img/me-cuisto/b3.jpg') }}" alt=" " class="img-responsive"></a>
            ...
            <div class="modal-body about">
                <div class="about">
                    ...
                    <div class="about-inner">
                        ...
                        <img src="{{ URL::asset('img/me-cuisto/b3.jpg') }}" alt="about"/>
  ...
  <div class="service-head one text-center">
    ...
    <div class="modal-content port-modal">
      ...
      <div class="row">
            ...
            <h3>Image-Title</h3>
                        <img src="{{ URL::asset('img/me-cuisto/pic4.jpg') }}" class="img-responsive img-centered" alt="">
    ...
    <div class="modal-content port-modal">
      ...
      <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <div class="modal-body">
            <h3>Image-Title</h3>
                        <img src="{{ URL::asset('img/me-cuisto/pic9.jpg') }}" class="img-responsive img-centered" alt="">
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-content port-modal">
      ...
      <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <div class="modal-body">
            <h3>Image-Title</h3>
                        <img src="{{ URL::asset('img/me-cuisto/pic5.jpg') }}" class="img-responsive img-centered" alt="">
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-content port-modal">
      ...
      <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <div class="modal-body">
            <h3>Image-Title</h3>
                        <img src="{{ URL::asset('img/me-cuisto/pic6.jpg') }}" class="img-responsive img-centered" alt="">
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-content port-modal">
      ...
      <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <div class="modal-body">
            <h3>Image-Title</h3>
                        <img src="{{ URL::asset('img/me-cuisto/pic10.jpg') }}" class="img-responsive img-centered" alt="">
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-content port-modal">
      ...
      <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <div class="modal-body">
            <h3>Image-Title</h3>
                        <img src="{{ URL::asset('img/me-cuisto/pic11.jpg') }}" class="img-responsive img-centered" alt="">
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-content port-modal">
      ...
      <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <div class="modal-body">
            <h3>Image-Title</h3>
                        <img src="{{ URL::asset('img/me-cuisto/pic13.jpg') }}" class="img-responsive img-centered" alt="">
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-content port-modal">
      ...
      <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <div class="modal-body">
            <h3>Image-Title</h3>
                        <img src="{{ URL::asset('img/me-cuisto/pic14.jpg') }}" class="img-responsive img-centered" alt="">
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    </div>
                </div>
            </div>
...
<div class="portfolio-modal modal fade slideanim" id="portfolioModal9" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-content port-modal">
      ...
      <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <div class="modal-body">
                        <img src="{{ URL::asset('img/me-cuisto/pic1.jpg') }}" class="img-responsive img-centered" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<!-- //for bootstrap working -->
  <script src="{{URL::asset('js/me-cuisto/bootstrap.js')}}"></script>
@endsection